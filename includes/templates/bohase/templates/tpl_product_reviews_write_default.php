        	...
        	<div class="content">
                ...
                <div class="review-links">
                    <div id="reviewsWriteProductPageLink" class="buttonRow">
                            <?php echo '<a class="btn btn-dark-blue btn-small-med" href="' . zen_href_link(zen_get_info_page($_GET['products_id']), zen_get_all_get_params()) . '">' . 
                    zen_image_button(BUTTON_IMAGE_GOTO_PROD_DETAILS , BUTTON_GOTO_PROD_DETAILS_ALT) . '</a>'; ?>
                    </div>
                    <div id="reviewsWriteReviewPageLink" class="buttonRow"><?php echo '<a class="btn btn-dark-blue btn-small-med" href="' . zen_href_link(FILENAME_REVIEWS) . '">' . zen_image_button(BUTTON_IMAGE_REVIEWS, BUTTON_REVIEWS_ALT) . '</a>'; ?>
                    </div>
                </div>
			</div>
        </div>
