...
//            $how_many++;
      ...
      if (PRODUCT_NEW_LIST_DESCRIPTION > '0') {
        ...
        $display_products_description = '';
			...
			/*Wishlist Links*/
			if (UN_MODULE_WISHLISTS_ENABLED) { $wishlist_link= '<a class="lnk" href="' . zen_href_link(UN_FILENAME_WISHLIST, 'products_id=' . $products_new->fields['products_id'] . '&action=wishlist_add_product') . '"><i class="fa fa-heart"></i>Wishlist</a>';}else{ $wishlist_link='';}
	
			$compare_link='<a class="lnk" href="javascript: compareNew('.$products_new->fields['products_id'].', \'add\')"><i class="fa fa-exchange"></i>Compare</a>';
