        	...
        	<div class="content">
            	<div class="row product-details-review">
            		<div class="smallProductImage back col-lg-3 col-md-3 col-sm-3 col-xs-12">
                		<?php echo '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' . (int)$_GET['products_id'] . '&reviews_id='. $reviews['id']) . '">' . zen_image(DIR_WS_IMAGES . $products_image, $product_name, MEDIUM_IMAGE_WIDTH, MEDIUM_IMAGE_HEIGHT) . '</a>'; ?>
            		</div>
                	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 product-review-default">
                        ...
                        ?>
                    	<p>
                    		<?php echo '<i class="fa fa-quote-left"></i>' . $product_review . '<a data-toggle="tooltip" data-original-title="Read Review" href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' . (int)$_GET['products_id'] . '&reviews_id='. $reviews['id']) . '">Read more</a>'; ?>
                    	</p>
                    	<footer>
                        	...
                        	<br/>
                        	<?php echo zen_image(DIR_WS_TEMPLATE_IMAGES . 'stars_' . $reviews['reviewsRating'] . '.png', sprintf(TEXT_OF_5_STARS, $reviews['reviewsRating'])), sprintf(TEXT_OF_5_STARS, $reviews['reviewsRating']); ?>
                    	</footer>
                	</div>
