        ...
        <div class="row">
			<?php
              if (zen_not_null($products_image)) {
                 ...
                 */
            ?>
            <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 reviews-info-productmain-image">
            ...
            ?>
        	<div class="col-lg-9 col-md-9 col-sm-7 col-xs-12 reviews-list">
                ...
                <div class="review-links">
                    <div class="buttonRow forward" id="reviewsWriteProductPageLink">
                        <?php echo '<a class="btn btn-dark-blue btn-small-med" href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, zen_get_all_get_params(array('reviews_id'))) . '">' . zen_image_button(BUTTON_IMAGE_WRITE_REVIEW, BUTTON_WRITE_REVIEW_ALT) . '</a>'; ?>		
                    </div>
                    <div id="reviewsWriteReviewPageLink" class="buttonRow">
						<?php echo '<a class="btn btn-dark-blue btn-small-med" href="' . zen_href_link(zen_get_info_page($_GET['products_id']), zen_get_all_get_params(array('reviews_id'))) . '">' . zen_image_button(BUTTON_IMAGE_GOTO_PROD_DETAILS , BUTTON_GOTO_PROD_DETAILS_ALT) . '</a>'; ?>
                    </div>
                    <?php 
                        if($reviews_counter > 0) {
                    ?>
                    <div id="reviewsWriteReviewPageLink" class="buttonRow">
                        <?php echo '<a class="btn btn-dark-blue btn-small-med" href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params(array('reviews_id'))) . '">'. zen_image_button(BUTTON_IMAGE_MORE_REVIEWS , BUTTON_MORE_REVIEWS_ALT) . '</a>' ; ?>
                    </div>
                    <?php } ?>
                </div>
            </div>
