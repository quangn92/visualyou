            ...
            <div class="row product-details-review">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 product-review-default">
                    <h4>
						...
						?>
                    <p>
						<?php echo '<i class="fa fa-quote-left"></i>' . $product_review . '<a data-toggle="tooltip" data-original-title="Read Review" href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' . $reviews->fields['products_id'] . '&reviews_id=' . $reviews->fields['reviews_id']) . '">Read more</a>'; ?>
                    </p>
                    <footer>
                        ...
                        <br/>
                        <?php echo zen_image(DIR_WS_TEMPLATE_IMAGES . 'stars_' . $reviews->fields['reviews_rating'] . '.png', sprintf(TEXT_OF_5_STARS, $reviews->fields['reviews_rating'])), sprintf(TEXT_OF_5_STARS, $reviews->fields['reviews_rating']); ?>
                    </footer>
                </div>
