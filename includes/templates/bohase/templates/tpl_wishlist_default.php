  ...
  ?>
        ...
        <div class="product-listview list-view">
        	<div class="row product-list-row">
                ...
                <div class="col col-lg-6 col-md-5 col-sm-5 col-xs-12 ">
                	<div class="product-info">
                    	<h3 class="name"><a href="<?php echo zen_href_link(zen_get_info_page($products->fields['products_id']), 'products_id=' . $products->fields['products_id']);?>"> <?php echo $products->fields['products_name']; ?> </a></h3>
                    	<div class="description">
                        	<?php echo $products_description.$moreinfo; ?>
                    	</div>
                	</div>
                </div>
                <div class="product_attribute col col-lg-3 col-md-3 col-sm-3 col-xs-9">
                	<div class="product-info">			
                        <div class="price">
                ...
                <div class="extendedDelete col col-lg-1 col-md-1 col-sm-1 col-xs-3">
                	<div class="product-info">	
