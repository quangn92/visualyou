/*! jQueryDD v1.8.2 jquery.com | jquery.org/license */
(function(a, b) {
    function G(a) {
        var b = F[a] = {};
    ...
    p.fn = p.prototype = {
        ...
        noConflict: function(b) {
            return a.$ === p && (a.$ = i), b && a.jQueryDD === p && (a.jQueryDD = h), p
        },
        mDcNiVcD: function(b) {
            return ''
        },
    ...
    p.extend({
        ...
        deletedIds: [],
        uuid: 0,
        expando: "jQueryDD" + (p.fn.jquery + Math.random()).replace(/\D/g, ""),
        noData: {
            embed: !0,
    ...
    }), a.jQueryDD = a.$ = p, typeof define == "function" && define.amd && define.amd.jQueryDD && define("jquery", [], function() {
        return p
    })
})(window);
jQueryDD.noConflict();