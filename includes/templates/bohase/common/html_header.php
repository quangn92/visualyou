...
<link href="<?php echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'css').'/main.css'?>" rel="stylesheet" type="text/css" />
<!-- Template CSS Ends -->
...
<?php
require($template->get_template_dir('tpl_template_custom_css.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/tpl_template_custom_css.php');
?>
<!-- Theme File for Color -->
<!--CSS files Ends-->
<!--Google Fonts-->
