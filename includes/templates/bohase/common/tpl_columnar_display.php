...
if (is_array($list_box_contents) > 0 ) 
	{
		...
		if($param6 == "categoryListBoxContents") 
		{ 
		?>
		...
		{ ?>
        	<div class="row">
            	<div class="product-slider">
                <div id="new-slider-reloaded" class="owl-carousel owl-theme">
                <?php
                for($row=0;$row<sizeof($list_box_contents);$row++)
                    {
                        $params = "";
		...
		{ ?>
        	<div class="row">
            	<div class="product-slider">
                <div id="specials-slider-reloaded"  class="owl-carousel owl-theme">
                <?php
                for($row=0;$row<sizeof($list_box_contents);$row++)
                    {
                        $params = "";
		...
		{ ?>
        	<div class="row">
            	<div class="product-slider">
                    <div id="bestsellers-slider" class="owl-carousel owl-theme">
                    <?php
                    for($row=0;$row<sizeof($list_box_contents);$row++)
                        {
                            $params = "";
