...
define('ERROR_INVALID_FROM_DATE', 'A partir de cette date est invalide.');
define('ERROR_INVALID_TO_DATE', 'Jusqu\'à cette date est invalide.');
define('ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'Jusqu\'à cette date doit être supérieur ou égal à à partir de cette date.');
define('ERROR_PRICE_FROM_MUST_BE_NUM', 'A partir de ce prix doit être un nombre.');
define('ERROR_PRICE_TO_MUST_BE_NUM', 'Jusqu\'à ce prix doit être un nombre !');
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'Jusqu\'à ce prix doit être supérieur ou égal à à partir de ce prix.');
