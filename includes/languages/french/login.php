...
define('TEXT_LOGIN_ERROR', 'Erreur : Désolé, aucune correspondance pour cette adresse email et ce mot de passe.');
...
define('TEXT_LOGIN_BANNED', 'Erreur : Accès non autorisé.');