 ...
 */
define('CEON_MANUAL_CARD_TEXT_CARDS_ACCEPTED', 'Cards Accepted:');
...
define('CEON_MANUAL_CARD_TEXT_CARD_EXPIRY_DATE', 'Card Expiry Date:');
define('CEON_MANUAL_CARD_TEXT_CARD_CV2_NUMBER', 'Card CV2 Number:');
...
define('CEON_MANUAL_CARD_TEXT_CARD_CV2_NUMBER_TICK_NOT_PRESENT', 'Tick here if card has no CV2 number.');
