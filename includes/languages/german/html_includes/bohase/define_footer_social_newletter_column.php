<div class="social-newsletter">
                        	<div class="social-links">
                                ...
                                <ul class="social list-inline list-unstyled">
                                    ...
                                    <li>
                                        <a class="fa fa-facebook" href="http://www.facebook.com/<?php echo $facebook_link;?>" target="_blank">
                                        </a>
                                    </li>
                                    <?php } ?>
                                    <?php if($twitter_link != NULL) {?>
                                    <li>
                                        <a class="fa fa-twitter" href="http://www.twitter.com/<?php echo $twitter_link;?>" target="_blank"></a>
                                    </li>
                                    <?php } ?>
                                    <?php if($pinterest_link != NULL) {?>
                                    <li>
                                        <a class="fa fa-pinterest" href="http://pinterest.com/<?php echo $pinterest_link;?>" target="_blank">
                                        </a>
                                    </li>
                                    <?php } ?>
