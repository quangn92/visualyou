...
**/
  function zenCssButton($image = '', $text, $type, $sec_class = '', $parameters = '') {
   ...
   $button_name = basename($image, '.gif');
    ...
    $mouse_out_class  = 'cssButton ' . (($type == 'submit') ? 'submit_button btn btn-small-med ' : 'normal_button ') . $sec_class;
    $mouse_over_class = 'cssButtonHover ' . (($type == 'button') ? 'normal_button ' : 'btn btn-small-med') . $sec_class . $sec_class . 'Hover';
