...
define('FILENAME_DEFINE_BRANDS_INFOBOXES', 'define_brands_infoboxes');
...
define('FILENAME_DEFINE_FOOTER_MORE_LOVE_LINKS', 'define_footer_more_love_links');
...
define('FILENAME_FEATURED_PRODUCTS_RELOADED_MODULE','featured_products_reloaded.php');
